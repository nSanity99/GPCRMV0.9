    ...
    <div class="module-page-container">
        <header class="page-header">
            <div class="header-branding">
                <a href="dashboard.php" class="header-logo-link"><img src="../assets/images/logo.png" alt="Logo Gruppo Vitolo" class="logo"></a>
            ...
            <form action="gestioneordini.php" method="get" class="filter-form">
                ...
                <div class="filter-grid">
                    ...
                    <div class="filter-actions">
                        ...
                        if ($totale_ordini > 0) {
                             echo '<a href="../actions/export_csv.php?report=gestione&' . $export_query . '" class="admin-button" style="background-color: #1D6F42;" target="_blank">Esporta Filtri in CSV</a>';
                        }
                        ?>
                    </div>
                </div>
        ...
        <footer class="footer-logo-area">
            <img src="../assets/images/logo.png" alt="Logo Gruppo Vitolo">
        </footer>
    </div>
