    ...
    <div class="module-page-container">
        <header class="page-header">
            <div class="header-branding">
                <a href="dashboard.php" class="header-logo-link"><img src="../assets/img/logo.png" alt="Logo Gruppo Vitolo" class="logo"></a>
        ...
        <footer class="footer-logo-area">
            <img src="../assets/img/logo.png" alt="Logo Gruppo Vitolo">
        </footer>
    </div>
