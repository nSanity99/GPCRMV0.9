    ...
    <div class="page-outer-container">
        <header class="module-header">
            <div class="header-branding">
                <a href="dashboard.php"> <img src="../assets/images/logo.png" alt="Logo Gruppo Vitolo" class="logo">
                </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    mainRequestForm.addEventListener('submit', function(event) {
        ...
        console.log("Tentativo di invio ordine a ../actions/submit_order_action.php...");
    });
});
</script>
