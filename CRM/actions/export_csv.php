...
if ($report_type === 'gestione') {
    ...
    // Ricostruisci la query di ../pages/gestioneordini.php
    ...
    // ... Aggiungi qui tutti gli altri filtri da ../pages/gestioneordini.php come li avevi...
...
if ($report_type === 'riepilogo') {
    ...
    // Ricostruisci la query di ../pages/riepilogo_ordini.php
